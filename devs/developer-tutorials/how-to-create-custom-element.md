...
slug: /developer-tutorials/how-to-create-custom-element
---
...
When you need one element inside another, you should use [nested shortcode techniques](https://codex.wordpress.org/Shortcode_API#Nested_Shortcodes). Please see [our article about container element](/devs/developer-tutorials/nested-shortcodes-container) which has an example of how to implement it.
