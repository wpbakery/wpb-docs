...
<div className="topic-cards">
  ...
  <a href="/docs/learning-more/wpbakery-ai" className="topic-card">
    <h3>WPBakery AI</h3>
    <p>Leverage AI-powered features to accelerate your content creation and page building workflow.</p>
  </a>

  <a href="/docs/learning-more/wpbakery-seo" className="topic-card">
    <h3>WPBakery SEO</h3>
  ...
  <a href="/docs/learning-more/templates" className="topic-card">
    <h3>Templates</h3>
