...
**Fifth:** To override class names that are applied to WPBakery Page Builder content elements you should use WordPress [add_filter("vc_shortcodes_css_class")](/docs/filters/vc_shortcodes_css_class).
