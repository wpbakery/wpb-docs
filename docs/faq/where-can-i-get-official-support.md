---
id: where-can-i-get-official-support
sidebar_position: 5
...
:::warning
Official WPBakery support is available only for direct clients with an active [support tenure](/docs/licensing/support-plus-licensing). If you have received any of WPBakery products within a theme you should ask your theme author for assistance.
:::
