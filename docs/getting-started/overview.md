...
<div className="topic-cards">
  ...
  <a href="/docs/getting-started/activation" className="topic-card">
    <h3>Activation</h3>
    <p>Activate your WPBakery Page Builder license to access updates and official support through the Support Portal.</p>
  </a>

  <a href="/docs/getting-started/update" className="topic-card">
    <h3>Update</h3>
    <p>Keep your plugin up to date with automatic or manual update methods for the latest features and bug fixes.</p>
  </a>
