...
- **Fix:** Image preview in the Backend editor works properly in Firefox
...
## Version 8.6.1 (05.08.2025)

- **Compatibility:** WPBakery and WPRocket works properly
- **Fix:** Design Options saving works properly

## Version 8.6 (04.08.2025)

- **New:** Keyboard shortcuts are introduced for the common editor functions
...
- **Fix:** The editor does not experience fatal errors

## Version 8.3.1 (18.03.2025)

- **Fix:** WordPress preview now works properly

## Version 8.3 (12.03.2025)
...
- **Update:** The license activation process improved after plugin installation and update

## Version 7.2 (09.11.2023)
...
- **Fix:** Round chart legend position works properly
...
## Version 6.9.0 (07.04.2022)

- **New:** Filter to disable full-width row JS
- **Update:** Option to set a custom color for the round chart element
...
## Version 5.6 (27.11.2018)

- **Update:** Compatibility with WordPress 5.0

## Version 5.5.4 (08.09.2018)

- **Fix:** Link selector works properly in the Backend editor

## Version 5.5.3 (07.09.2018)
...
- **Fix:** Single image element works properly in the Firefox browser

## Version 5.5.2 (27.06.2018)

- **Fix:** “WPBMap Uncaught Exception” for modifyParam API method

## Version 5.5.1 (22.06.2018)

- **Fix:** “WPBMap Uncaught Exception” for dropParam and addParam API methods

## Version 5.5 (20.06.2018)
...
- **Fix:** Extra p tags in the grid removed
...
- **Fix:** Builder.parse in the Frontend editor
...
## Version 5.4.7 (08.03.2018)

- **Fix:** Custom shortcode mapping

## Version 5.4.6 (07.03.2018)
...
## Version 5.4.2 (12.10.2017)

- **Fix:** “Update failed: Download failed. A valid URL was not provided.”
- **Fix:** CSS files not found error

## Version 5.4 (12.10.2017)
...
- **Fix:** Param saving dependant on the checkbox
...
- **Update:** With the new color scheme comes the new name WPBakery Page Builder

## Version 5.2.1 (03.08.2017)
...
- **Fix:** TinyMCE performance in the Backend editor
...
- **Fix:** Hiding all “Tabs” in the tab module still displays an active item
- **Fix:** php 7.1 compatibility issues

## Version 5.0.1 (17.11.2016)

- **Improved:** Auto-update process on hostings with the wrong chmod on /tmp directory
- Fixed: CSS Animation “none” works differently on save
- Fixed: prettyPhoto jumps upon closing in firefox
- Fixed: Section in template breaks
- Fixed: Warning for array_merge in vc_gitem_template_attribute_post_image_url

## Version 5.0 (09.11.2016)
...
- **Update:** all elements have CSS animation attribute
...
- **Update:** Additional element description in the Backend editor
- **Update:** Video background autoplay on mobile devices
- **Update:** Refactor grid params array system
- **Update:** In some cases the relative path to admin-ajax.php returned 404, replaced with full path
...
## Version 4.10 (09.02.2016)


## Version 4.9.2 (12.11.2015)

- Fixed: “Editing an existing Post Grid, page IDs are displayed instead of titles.”
- Fixed: Extra CSS class name for a single image in post grid
- Fixed: Third elements not working in templates
- Fixed: Visual Composer button is now added even if the post doesn’t support title
- Fixed: Yoast + single image without a default value
- Fixed: Grid builder on multisite
- Fixed: 404 error on WP multisite
- **Improved:** Tab activation through the menu (links on the same page)
- **Improved:** PHP7 compatibility

## Version 4.9.1 (23.12.2015)

- **Improved:** VC save action is fired on wp save_post instead of edit_post
- **Improved:** Some unneeded files removed from the package
- Fixed: Element is calling the save method only if changes were made
- Fixed: svg image selection in the single image element
- Fixed: image style in the post grid is now applied correctly
- Fixed: Equal height in Safari

## Version 4.8 (24.10.2015)


## Version 4.7.4 (02.10.2015)

- Fixed: Bug in grid builder presets
- Added extra ajax check

## Version 4.7.3 (29.09.2015)
...
## Version 4.7 (28.08.2015)


## Version 4.6.2 (23.07.2015)
...
## Version 4.3.5 (19.12.2014)

- Compatibility with WordPress 4.1

## Version 4.3.4 (10.09.2014)
...
## Version 4.3.1 (31.07.2014)

- Obsolete vc_spanX classes removed (caused problems for some users)
- Fixed: “Ilegal offset type in … shortcodes.php”

## Version 4.3 (29.07.2014)
...
- **New:** Control your layout across multiple devices. Now you can set different column width for mobile and desktop layouts
...
- front_enqueue_css and front_enqueue_js added in vc_map()
...
## Version 4.1.2 (22.04.2014)

- WP 3.9 compatibility update
- php warning/notices in mapper.php
- Read more text in post grid is now translatable
...
## Version 4.1.1 (17.04.2014)

- z-index value for add element modal box increased
- Improved element stacking on mobile devices
...
## Version 4.1 (16.04.2014)

- **New:** Shortcode Mapper, map any third party shortcode to Visual Composer with an easy to use interface
- **New:** Design options for Row, Columns, Text block, Single image and Video block elements. Add background color/image, paddings, border and margins. Tons of variations. You are a designer now!
...
- Color picker have alpha channel now
- .po/.mo files updated

## Version 4.0.5 (09.04.2014)
...
## Version 4.0.2 (11.03.2014)

- Google maps element updated to support new google maps version
- Child theme support added
- Disable responsiveness is back
- h1 css rules, normalize.css and print.css removed from final js_composer_front.css removed
...
- Sprite for predefined row layouts added
- “Close” modal button in backend position tweak added
- Updated .po/.mo files

## Version 4.0.1 (03.03.2014)
...
## Version 3.7.1 (27.11.2013)

- vc_remove_element() is back

## Version 3.7 (26.11.2013)
...
- **New:** Now third party developers can easily create nested shortcodes Eg: [items][single_item][single_item][/items]
...
## Version 3.6.14.1 (07.10.2013)

- Re: URL for single image improved
- Dependency improvements

## Version 3.6.14 (07.10.2013)
...
## Version 3.6.5 (17.06.2013)

- **New:** Shortcode Template logic
- **New:** Link param type
...
## Version 3.6 (13.05.2013)

- Fully rewritten backend. Now powered by backbone.js library – enormous speed improvements
...
- And a lot more small things that will make your experience with Visual Composer better

## Version 3.5.5 (27.03.2013)

- New content elements: Revolution slider, Layer Slider, Contact Form 7
- Extra CSS now added correctly with “Message box” element

## Version 3.5.4 (04.03.2013)
...
## Version 3.5 (22.01.2013)

- Major update
- Fully rewritten backend UI, with better row->column logic
...
## Version 3.4.13 (22.01.2013)

- eval() removed $$ used instead
- media tab method(‘destroy’) error fixed
- single image heading added
- 1/6 + 5/6 containers saving fixed

## Version 3.4.12 (18.12.2012)

- Edit tab titles fixed

## Version 3.4.11 (13.12.2012)
...
## Version 3.4.10 (12.12.2012)

- Accordion “freezing” fixed
- WP 3.5 compatibility fixes added

## Version 3.4.9 (29.11.2012)

- Introduced developers methods
- Excerpts now are working for posts/pages created with Visual Composer
- Nivo slider updated (ver. 3.1)
- Responsive css can be turned off from Visual Composer settings page

## Version 3.4.8 (15.11.2012)
...
## Version 3.4.6 (05.11.2012)

- Raw HTML and Raw js content blocks updated

## Version 3.4.5 (31.10.2012)

- Fixed shortcodes initialization ( …)

## Version 3.4.4 (23.10.2012)

- wamp environment fix

## Version 3.4.3 (16.10.2012)

- fixed “Empty visual editor”

## Version 3.4.2 (12.10.2012)

- mapper.php bug fixed
- fixed “Call to undefined function get_currentuserinfo()”

## Version 3.4.1 (10.10.2012)

- Activation bug fix
- Additional small improvements

## Version 3.4 (05.10.2012)
...
- Raw html/Raw js content blocks non latin characters fixed
...
## Version 3.3.2 (27.08.2012)

- Second attempt with “Featured image” fix

## Version 3.3.1 (21.08.2012)

- add_them_support(‘post-thumbnails’); extends post thumbnails defined by theme

## Version 3.3 (16.08.2012)
...
## Version 3.2.3 (09.08.2012)

- Settings page enhancements

## Version 3.2.1 (25.07.2012)

- Switching between tabs fixed

## Version 3.2.0 (23.07.2012)
...
- Administrator now can set user roles related settings in Visual Composer->Settings
...
## Version 3.0.4 (10.05.2012)

- HTML Comments removed from generated html code. Some themes wrapped them in tag

## Version 3.0.3 (27.04.2012)
...
## Version 3.0.2 (15.04.2012)

- bootstrap.css cleaned, unused classes removed.

## Version 3.0.1 (14.04.2012)
...
- .po file updated
- .container class name comment out from bootstrap.css file. Because it isn’t used within the plugin, but conflicts with 3rd part themes

## Version 3.0 (11.04.2012)
...
## Version 2.2.1 (22.09.2011)

- New content block added – “Text separator”

## Version 2.2.0 (15.09.2011)
